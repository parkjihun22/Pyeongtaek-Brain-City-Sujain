...
<Helmet>
  ...
  <meta property="og:title" content="평택 브레인시티 수자인 - 커뮤니티" />
  <meta
...
<p className={styles.screenReaderOnly}>
  평택 브레인시티 수자인의 커뮤니티 페이지에서는 단지 내 다양한 시설을 소개합니다.
  피트니스센터, 실내 골프연습장, 작은도서관(북카페), 주민 라운지 등 생활의 품격을 높이고,
  입주민의 취미와 휴식을 고려한 공간으로 더 나은 일상을 지원합니다.
</p>

<div className={styles.textBox}>
  <div>일상에 여유를 더하다</div>
  <div>평택 브레인시티 수자인의 프리미엄 커뮤니티를 만나보세요</div>
</div>
      ...
      <img
				...
				src={page1}
				alt="평택 브레인시티 수자인커뮤니티 안내 -image1"
