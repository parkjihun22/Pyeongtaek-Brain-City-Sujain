...
const section3Contents = [
  {
    ...
    title: "PREMIUM 01",
    text1: `브랜드 프리미엄 단지`,
    text2: `총 889세대 수자인<br/>
            지하 2층~지상 25층 · 11개동 · 공원형 설계`,
  ...
  },
  {
    ...
    title: "PREMIUM 04",
    text1: `커뮤니티 특화 설계`,
    text2: `피트니스·실내골프·작은도서관 등 다채로운 시설<br/>
            쾌적한 일상을 위한 프리미엄 커뮤니티`,
        ...
        <>
          ...
          <div className={styles.imageContainer}>
            ...
            <div className={styles.mainImageTitleBox}>
              <div className={styles.mainImageText}>평택이 기다린 미래 프리미엄</div>
          ...
          <div className={styles.section}>
            <div className={styles.section2}>
              ...
              <img
                src={section2_Image1}
                alt="평택 브레인시티 수자인아파트 조감도-image3"
                loading="lazy"
                decoding="async"
              />
            </div>
          ...
          <div className={styles.pcVisitContainer}>
            ...
            <form
              ...
              action="https://formspree.io/f/xldzrpro"
              method="POST"
            >
              <label htmlFor="name">
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="평택 브레인시티 수자인오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.imageContainer}>
            <img
              src={mobileImageMain}
              className={styles.mainImage}
              alt="평택 브레인시티 수자인mobilemain-image1"
            />
            <div className={styles.overlay}></div>
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 평택 브레인시티 수자인에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="평택 브레인시티 수자인모바일 조감도 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="평택 브레인시티 수자인브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="평택 브레인시티 수자인오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
