...
<Helmet>
  <title>평택 브레인시티 수자인 - 모집공고 안내</title>
  <meta
    name="description"
  ...
  <meta property="og:title" content="평택 브레인시티 수자인 - 모집공고 안내" />
  <meta
  ...
  <meta name="twitter:title" content="평택 브레인시티 수자인 - 모집공고 안내" />
  <meta
...
<h1 className={styles.screenReaderOnly}>
  평택 브레인시티 수자인 - 모집공고 안내
</h1>
<p className={styles.screenReaderOnly}>
  본 페이지에서는 평택 브레인시티 수자인의 모집공고 주요 사항을 안내합니다.
