  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        <meta
          name="description"
          content="평택 브레인시티 수자인 분양 전 필수 체크포인트를 확인하세요. 청약 자격(거주기간·무주택·예치금), 특별공급 유형, 필요서류·일정, 유의사항을 한눈에 안내합니다."
        />
      ...
      <p className={styles.screenReaderOnly}>
        평택 브레인시티 수자인 분양 전 확인해야 할 핵심 체크리스트입니다.
      ...
      <div className={styles.textBox}>
        ...
        <div>평택 브레인시티 수자인, 분양 전 체크포인트를 확인하세요.</div>
      </div>
      ...
      <img
        ...
        src={page1}
        alt="평택 브레인시티 수자인청약제도 변경안내 이미지1"
