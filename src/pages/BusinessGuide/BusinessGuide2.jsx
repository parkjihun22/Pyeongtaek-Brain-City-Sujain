...
<h1 className={styles.screenReaderOnly}>평택 브레인시티 수자인 - 분양일정</h1>
<p className={styles.screenReaderOnly}>
  평택 브레인시티 수자인의 분양(청약) 일정을 한곳에서 확인하세요.
  모델하우스 오픈일, 특별공급과 1·2순위 청약 접수일, 당첨자 발표 및 정당계약 기간 등
  주요 일정을 상세히 안내합니다.
</p>

<div className={styles.textBox}>
  <div>889세대 브랜드 대단지의 시작</div>
  <div>평택 브레인시티 수자인, 청약 일정을 확인하세요</div>
</div>



            {/* ✅ 기존 이미지 부분 주석 처리하고 Ready 컴포넌트 표시 */}
            <img className={`${styles.image4} ${isImageVisible ? styles.visible : ''}`} src={page1} alt="평택 브레인시티 수자인분양일정안내-image1" />
