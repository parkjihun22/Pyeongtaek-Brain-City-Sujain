...
<Helmet>
  ...
  <meta
    name="description"
    content="평택 브레인시티 수자인 분양 계약에 필요한 서류 안내. 신분증, 주민등록등본, 인감증명서 등 필수 제출서류와 준비 절차, 유의사항을 확인하세요."
  />
...
<h1 className={styles.screenReaderOnly}>평택 브레인시티 수자인 - 계약서류안내</h1>
<p className={styles.screenReaderOnly}>
  본 페이지는 평택 브레인시티 수자인 분양 계약을 위한 서류 제출 절차를 안내합니다.
  신분증, 주민등록등본, 인감증명서 등 필수 제출서류 목록과 준비 방법, 유의사항을
  사전에 확인해 빠르고 정확한 계약을 진행하세요.
</p>

<div className={styles.textBox}>
  <div>계약은 꼼꼼하게, 준비는 여유롭게</div>
  <div>평택 브레인시티 수자인 계약서류를 미리 확인하세요</div>
</div>



			{/* 이미지에 isImageVisible 상태 적용 */}
			{/* <img className={`${styles.image4} ${isImageVisible ? styles.visible : ''}`} src={page1} alt="평택 브레인시티 수자인계약서류안내-image1" /> */}
